  ...
  <div class="container">
    ...
    <div class="product-edit">
      <div class="product-image">
        <img src="img/product/hinhconnguoi.jpg" alt="Ảnh sản phẩm">
      </div>
      <div class="product-details">
        <form id="edit-product-form">
          <div class="form-group">
            <label for="product-name">Tên người dùng:</label>
            <input type="text" id="product-name" name="product-name" value="Nguoidung1234">
          </div>
          <div class="form-group">
            <label for="product-price">Địa chỉ email:</label>
            <input type="text" id="product-price" name="product-price" value="Nguoidung1234@email.com">
          </div>
          <div class="form-group">
            <label for="product-price">Ngày sinh:</label>
            <input type="text" id="product-price" name="product-price" value="01/01/2024">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" id="product-price" name="product-price" value="1234 An Duong Vuong Q5, TP.HCM">
          </div>
          <div class="button-group" style="display: flex; justify-content: center; align-items: center; height: 100px;">
